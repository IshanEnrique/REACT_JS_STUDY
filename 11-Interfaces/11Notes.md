...
## Interfaces can be implemented with class and the class will be required to provide all the implementation of the protocols defined by Interface .

- Intercace implementation example - 
